...
<form method = "post" id="formvenda" action="../index.php/?controle=venda&acao=editarlavada">
    <table border = 0 class = "tableavenda">
        <tr>
            <td >
                <input type="hidden" name = "id" class="form-select" value="<?php echo $_GET["id"];?>" >
                <input type="hidden" id="inputficha" class="form-select" value="<?php echo $_SESSION["editarvenda"][1];?>">
                <label>Ficha:</label>
                <select id = "idficha" name="editarficha" class="form-select">
                    <option value = "">---</option>
            ...
            <td>
                <label>Veiculo:</label>
                <input type="hidden" id="inputveiculo" class="form-select" value="<?php echo $_SESSION["editarvenda"][3];?>">
                <select name="editarveiculo" id="txt1" class="form-select"  onmouseup="showHint()">
            ...
            <td>
                <label>Lavada:</label>
                <input type="hidden" id="inputlavada" class="form-select" value="<?php echo $_SESSION["editarvenda"][4];?>">
                <select name = "editarlavada" id="txt2" class="form-select" .value onmouseup="showHint()">
                    <option value = "" selected>---------------------------------</option>
        ...
        <tr>
            <td>
                <label>Valor:    
                <input type="text" name="editarvalor" id="txtHint" class="form-select" value ="<?php echo $_SESSION["editarvenda"][7];?>">
            </td>
        </tr>
        <tr>     
            <td>
                <label>Pagamento:</label>    
                <input type="hidden" id="inputpagamento" class="form-select" value="<?php echo $_SESSION["editarvenda"][6];?>">
                <select name="editarpagamento" id ="idpagamento" class="form-select">
                    <option value = "" selected>----------------------</option>
        ...
        <tr>
            <td>                
                <label>Placa:</label>    
                <input type="text" name ="editarplaca" class="form-select" value ="<?php echo $_SESSION["editarvenda"][2];?>">
            </td>
        </tr>
        <tr>
            <td>                
                <label>Empresa:</label>    
                <input type="text" name ="editarempresa" class="form-select" value ="<?php echo $_SESSION["editarvenda"][5];?>">
            </td>
        </tr>
        <tr>
            <td>                
                <label>N° Nota:</label>    
                <input type="text" name="editarnum_nota" class="form-select" value ="<?php echo $_SESSION["editarvenda"][8];?>">
            </td>
        </tr>
        <tr>
            <td>                
                <label>Anotacao:</label>    
                <input type="text" name="editaranotacao" class="form-select"  value ="<?php echo $_SESSION["editarvenda"][9];?>">
            </td>
        </tr>
        <tr>
            <td>
